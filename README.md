...
| `contrada-monitor.yml` | daily 05:00 UTC | Site + email uptime monitor for contradatezzamicheloni.it, reports to Telegram | `CONTRADA_TELEGRAM_BOT_TOKEN`, `CONTRADA_TELEGRAM_CHAT_ID` |
